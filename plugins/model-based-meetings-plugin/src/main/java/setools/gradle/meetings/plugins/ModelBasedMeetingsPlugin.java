...
import setools.gradle.meetings.api.internal.UmlMeetingFactory;
import setools.gradle.model.plugins.ModellingBasePlugin;

/**
 * TODO:
 */
public class ModelBasedMeetingsPlugin implements Plugin<Project> {
