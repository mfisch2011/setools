 ...
 *
 */
public abstract class AbstractDraftSlides extends GenerateTask {
	...
	@Inject
	public AbstractDraftSlides(Meeting meeting) {
	 ...
	 * @throws OOXMLException 
	 */
	protected abstract ArrayList<XSLFSlide> buildSlides(XMLSlideShow presentation) throws OOXMLException;
