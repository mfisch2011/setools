...
import setools.gradle.dsl.agenda.internal.DefaultAgendaHandler;
import setools.gradle.dsl.attendee.AttendeeHandler;
import setools.gradle.dsl.attendee.internal.DefaultAttendeeHandler;
...
public class DefaultMeeting implements Meeting {
	...
	public DefaultMeeting(Project project) {
		...
		this.agenda = new DefaultAgendaHandler();
		this.backups = new DefaultAgendaHandler();
