...
import setools.gradle.tasks.DraftRiskDetails;
...
public class RegisterRiskReview extends RegisterMeetingLifecycle {
	...
	protected void addTopicSlideTasks(Project project,AgendaItem topic) throws ClassNotFoundException {
		...
		if(formatter!=null) {
			...
			if(task instanceof DraftRiskDetails) {
				((DraftRiskDetails)task).setSource("src/project/risk"); //TODO:more gradle way collecting risk sourceSets...
			}
