 ...
 *
 */
public class SysML14ResourcesUtil extends UMLUtil {
	...
	*/
	public static Map<URI, URI> initURIConverterURIMap(Map<URI, URI> uriMap) {
		...
		mapURIs(uriMap, "platform:/plugin/org.eclipse.papyrus.sysml14/resources/", //$NON-NLS-1$
			umlURI.appendSegment("profile"), "org.eclipse.papyrus.sysml14"); //$NON-NLS-1$ //$NON-NLS-2$
