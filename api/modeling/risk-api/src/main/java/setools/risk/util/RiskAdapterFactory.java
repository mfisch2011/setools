...
public class RiskAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected RiskSwitch<Adapter> modelSwitch = new RiskSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link setools.risk.Risk
	 * <em>Risk</em>}'. <!-- begin-user-doc --> This default implementation returns
	 ...
	 * '{@link setools.risk.RiskMitigation <em>Mitigation</em>}'. <!--
	 ...
	 * @generated
	 */
	public Adapter createRiskMitigationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class
	 * '{@link setools.risk.StatusUpdate <em>Status Update</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
