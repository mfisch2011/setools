 ...
 * TODO:
 */
public class RiskResourcesUtil extends UML2Util {
	...
	public static Map<URI, URI> initURIConverterURIMap(Map<URI, URI> uriMap) {
		...
		mapURIs(uriMap, RiskResource.PROFILES_PATHMAP,
	...
	public static Map<String, URI> initEPackageNsURIToProfileLocationMap(
		...
		ePackageNsURIToProfileLocationMap.put(RiskResource.PROFILE_URI,
	...
	private static URI getBaseRiskURI() {
		URL resultURL = RiskResourcesUtil.class.getClassLoader()
			.getResource(String.format("model/%s", "risk.ecore")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		if (resultURL != null) {
			...
			resultURL = RiskResourcesUtil.class.getResource("RiskResourcesUtil.class"); //$NON-NLS-1$
	...
	private static URI getBaseRiskResourcesURI() {
		URI umlMetamodel = URI.createURI(RiskResource.PROFILE_PATH);
		...
		if (resultURL != null) {
			...
			resultURL = RiskResourcesUtil.class
				.getResource("RiskResourcesUtil.class"); //$NON-NLS-1$
